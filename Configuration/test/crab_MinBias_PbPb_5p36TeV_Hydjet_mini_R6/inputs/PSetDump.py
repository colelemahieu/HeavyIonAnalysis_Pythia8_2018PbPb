...
process.ak6PFJets = cms.EDProducer("CSJetProducer",
...
process.ak6PFpatJetCorrFactors = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
...
process.ak6PFpatJetFlavourAssociationLegacy = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("ak6PFpatJetPartonAssociationLegacy")
)


process.ak6PFpatJetGenJetMatch = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("ak6GenJetsNoNu"),
...
process.ak6PFpatJetPartonAssociationLegacy = cms.EDProducer("JetPartonMatcher",
...
process.ak6PFpatJetPartonMatch = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
...
process.ak6PFpatJets = cms.EDProducer("PATJetProducer",
    ...
    discriminatorSources = cms.VInputTag(cms.InputTag("ak6PFpfDeepCSVJetTags","probb"), cms.InputTag("ak6PFpfDeepCSVJetTags","probc"), cms.InputTag("ak6PFpfDeepCSVJetTags","probudsg"), cms.InputTag("ak6PFpfDeepCSVJetTags","probbb"), cms.InputTag("ak6PFpfJetProbabilityBJetTags")),
    ...
    genJetMatch = cms.InputTag("ak6PFpatJetGenJetMatch"),
    genPartonMatch = cms.InputTag("ak6PFpatJetPartonMatch"),
    getJetMCFlavour = cms.bool(True),
    jetChargeSource = cms.InputTag("patJetCharge"),
    jetCorrFactorsSource = cms.VInputTag("ak6PFpatJetCorrFactors"),
...
process.ak6PFpfDeepCSVJetTags = cms.EDProducer("DeepFlavourJetTagsProducer",
    ...
    src = cms.InputTag("ak6PFpfDeepCSVTagInfos"),
    toAdd = cms.PSet(
...
process.ak6PFpfDeepCSVTagInfos = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
    ...
    svTagInfos = cms.InputTag("ak6PFpfSecondaryVertexTagInfos")
)


process.ak6PFpfImpactParameterTagInfos = cms.EDProducer("CandIPProducer",
...
process.ak6PFpfJetProbabilityBJetTags = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetProbabilityComputer'),
    tagInfos = cms.VInputTag("ak6PFpfImpactParameterTagInfos")
)


process.ak6PFpfSecondaryVertexTagInfos = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("secondaryVertices"),
    extSVDeltaRToJet = cms.double(0.3),
    minimumTrackWeight = cms.double(0.5),
    trackIPTagInfos = cms.InputTag("ak6PFpfImpactParameterTagInfos"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.ak6PFJetAnalyzer = cms.EDAnalyzer("HiInclusiveJetAnalyzer",
    ...
    genParticles = cms.untracked.InputTag("prunedGenParticles"),
    genPtMin = cms.untracked.double(5),
    genjetTag = cms.InputTag("ak6GenJetsNoNu"),
    hltTrgResults = cms.untracked.string('TriggerResults::HISIGNAL'),
    isMC = cms.untracked.bool(True),
    jetName = cms.untracked.string('ak6PF'),
    jetPtMin = cms.double(5.0),
    jetTag = cms.InputTag("ak6PFpatJets"),
    matchTag = cms.untracked.InputTag("akPu4PFpatJets"),
    pfCandidateLabel = cms.untracked.InputTag("packedPFCandidates"),
    rParam = cms.double(0.6),
    towersSrc = cms.InputTag("towerMaker"),
...
process.jetsR6 = cms.Sequence(process.ak6PFJets+process.ak6PFpatJetCorrFactors+process.ak6PFpatJetPartonMatch+process.ak6GenJetsNoNu+process.ak6PFpatJetGenJetMatch+process.ak6PFpatJetPartonAssociationLegacy+process.ak6PFpatJetFlavourAssociationLegacy+process.ak6PFpatJetPartons+process.ak6PFpfImpactParameterTagInfos+process.ak6PFpfSecondaryVertexTagInfos+process.ak6PFpfDeepCSVTagInfos+process.ak6PFpfDeepCSVJetTags+process.ak6PFpfJetProbabilityBJetTags+process.ak6PFpatJets)
...
process.forest = cms.Path(process.HiForestInfo+process.l1object+process.trackSequencePbPb+process.particleFlowAnalyser+process.hiEvtAnalyzer+process.HiGenParticleAna+process.unpackedMuons+process.correctedElectrons+process.ggHiNtuplizer+process.muonAnalyzer+process.extraJetsMC+process.jetsR6+process.ak6PFJetAnalyzer)
