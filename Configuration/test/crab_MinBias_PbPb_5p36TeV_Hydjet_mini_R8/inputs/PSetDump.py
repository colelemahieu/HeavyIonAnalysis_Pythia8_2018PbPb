...
process.ak8PFJets = cms.EDProducer("CSJetProducer",
...
process.ak8PFpatJetCorrFactors = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
...
process.ak8PFpatJetFlavourAssociationLegacy = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("ak8PFpatJetPartonAssociationLegacy")
)


process.ak8PFpatJetGenJetMatch = cms.EDProducer("GenJetMatcher",
...
process.ak8PFpatJetPartonAssociationLegacy = cms.EDProducer("JetPartonMatcher",
...
process.ak8PFpatJetPartonMatch = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
...
process.ak8PFpatJets = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("ak8PFpatJetFlavourAssociation"),
    JetPartonMapSource = cms.InputTag("ak8PFpatJetFlavourAssociationLegacy"),
    ...
    discriminatorSources = cms.VInputTag(cms.InputTag("ak8PFpfDeepCSVJetTags","probb"), cms.InputTag("ak8PFpfDeepCSVJetTags","probc"), cms.InputTag("ak8PFpfDeepCSVJetTags","probudsg"), cms.InputTag("ak8PFpfDeepCSVJetTags","probbb"), cms.InputTag("ak8PFpfJetProbabilityBJetTags")),
    ...
    genJetMatch = cms.InputTag("ak8PFpatJetGenJetMatch"),
    genPartonMatch = cms.InputTag("ak8PFpatJetPartonMatch"),
    getJetMCFlavour = cms.bool(True),
    jetChargeSource = cms.InputTag("patJetCharge"),
    jetCorrFactorsSource = cms.VInputTag("ak8PFpatJetCorrFactors"),
...
process.ak8PFpfDeepCSVJetTags = cms.EDProducer("DeepFlavourJetTagsProducer",
    ...
    src = cms.InputTag("ak8PFpfDeepCSVTagInfos"),
    toAdd = cms.PSet(
...
process.ak8PFpfDeepCSVTagInfos = cms.EDProducer("DeepNNTagInfoProducer",
    computer = cms.PSet(
    ...
    svTagInfos = cms.InputTag("ak8PFpfSecondaryVertexTagInfos")
)


process.ak8PFpfImpactParameterTagInfos = cms.EDProducer("CandIPProducer",
...
process.ak8PFpfJetProbabilityBJetTags = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetProbabilityComputer'),
    tagInfos = cms.VInputTag("ak8PFpfImpactParameterTagInfos")
)


process.ak8PFpfSecondaryVertexTagInfos = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("secondaryVertices"),
    extSVDeltaRToJet = cms.double(0.3),
    minimumTrackWeight = cms.double(0.5),
    trackIPTagInfos = cms.InputTag("ak8PFpfImpactParameterTagInfos"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.ak8PFJetAnalyzer = cms.EDAnalyzer("HiInclusiveJetAnalyzer",
    ...
    genParticles = cms.untracked.InputTag("prunedGenParticles"),
    genPtMin = cms.untracked.double(5),
    genjetTag = cms.InputTag("ak8GenJetsNoNu"),
    hltTrgResults = cms.untracked.string('TriggerResults::HISIGNAL'),
    isMC = cms.untracked.bool(True),
    jetName = cms.untracked.string('ak8PF'),
    jetPtMin = cms.double(5.0),
    jetTag = cms.InputTag("ak8PFpatJets"),
    matchTag = cms.untracked.InputTag("akPu4PFpatJets"),
    pfCandidateLabel = cms.untracked.InputTag("packedPFCandidates"),
    rParam = cms.double(0.8),
    towersSrc = cms.InputTag("towerMaker"),
...
process.jetsR8 = cms.Sequence(process.ak8PFJets+process.ak8PFpatJetCorrFactors+process.ak8PFpatJetPartonMatch+process.ak8GenJetsNoNu+process.ak8PFpatJetGenJetMatch+process.ak8PFpatJetPartonAssociationLegacy+process.ak8PFpatJetFlavourAssociationLegacy+process.ak8PFpatJetPartons+process.ak8PFpfImpactParameterTagInfos+process.ak8PFpfSecondaryVertexTagInfos+process.ak8PFpfDeepCSVTagInfos+process.ak8PFpfDeepCSVJetTags+process.ak8PFpfJetProbabilityBJetTags+process.ak8PFpatJets)
...
process.forest = cms.Path(process.HiForestInfo+process.l1object+process.trackSequencePbPb+process.particleFlowAnalyser+process.hiEvtAnalyzer+process.HiGenParticleAna+process.unpackedMuons+process.correctedElectrons+process.ggHiNtuplizer+process.muonAnalyzer+process.extraJetsMC+process.jetsR8+process.ak8PFJetAnalyzer)
