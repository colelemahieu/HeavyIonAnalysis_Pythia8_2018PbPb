...
{    
  ...
  // histograms
  TH1F *h_leadingJet = new TH1F("h_leadingJet","h_leadingJet",60,0,60);
  TH1F *h_subleadingJet = new TH1F("h_subleadingJet","h_subleadingJet",60,0,60);
  ...
  for (int i=thirdEntries; i<jetentries; i++)
    {
      jetchain->GetEntry(i);
      ...
      h_leadingJet->Fill(genPt[0]);
      h_subleadingJet->Fill(genPt[1]);
